...
struct HomeView: View {
  ...
  let allLifts: [LiftEntry] = [
    LiftEntry(
      ...
      weight: randomWeight(min: 225, max: 275)
    ),
    LiftEntry(
      liftType: .backSquat,
      date: randomDateWithinLastTwoYears(),
    ...
    LiftEntry(
      liftType: .frontSquat,
      date: randomDateWithinLastTwoYears(),
      weight: randomWeight(min: 185, max: 270)
    ),
    LiftEntry(
      liftType: .frontSquat,
      date: randomDateWithinLastTwoYears(),
    ...
    LiftEntry(
      liftType: .deadlift,
      date: randomDateWithinLastTwoYears(),
      weight: randomWeight(min: 225, max: 310)
    ),
    LiftEntry(
      liftType: .deadlift,
      date: randomDateWithinLastTwoYears(),
      ...
      NavigationView {
        ScrollView {
          LazyVGrid(columns: columns, spacing: 8) {
            ForEach(addedLiftTypes, id: \.self) { liftType in
